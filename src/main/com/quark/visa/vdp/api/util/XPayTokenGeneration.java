package com.quark.visa.vdp.api.util;
...
public class XPayTokenGeneration {
	 ...
	 */
	public static String generateXpaytoken(String payload, String uri, String apiKey, String sharedSecret) throws SignatureException {
		System.out.println(uri);
		String timestamp = timeStamp();
		String beforeHash = timestamp + uri + "apikey=" + apiKey + payload;
