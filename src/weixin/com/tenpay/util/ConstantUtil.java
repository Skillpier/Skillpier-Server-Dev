...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxc9291be4fd0a7b15";//微信开发平台应用id
	//public static String APP_SECRET = "8185ed45b0c5a59d342ed2d6209da6e0";//应用对应的凭证
	//应用对应的密钥
	public static String APP_KEY = "yuzongyuzongyuzongyuzongyuzong12";
	public static String PARTNER = "1331991901";//财付通商户号
