...
public class SendMail {
	...
	public static void main(String[] args) throws MessagingException 
	{
        ...
        props.put("mail.from", "simon_hu@skillpier.com");
        ...
        String to = "2318680679@qq.com";
        String subject = "subject";
        String msg ="email text....";
        final String from ="simon_hu@skillpier.com";
        final  String password ="Skillpier123";
       ...
       transport.close();
		...
		//send("邮件主题","2318680679@qq.com", "邮件内容");
	}
}
