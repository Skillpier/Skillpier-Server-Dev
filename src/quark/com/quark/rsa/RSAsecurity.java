...
public class RSAsecurity {
	...
	// 私钥文件路径
	static String privateFile = config.rsa_key_path + "/private_pkcs8_der.key";
	// 公钥文件路径
	static String publicFile = config.rsa_key_path + "/public_key.der";
	//des 加密
	...
	public static void main(String[] args) throws Exception {
		String pwd="12345678";
		// 客户端加密
		String data = DESAndRSAEncrypt(pwd);
		System.out.println("pwd RSA加密后base64："+data);
		// 服务端解密
		String textDecrypt = DESAndRSADecrypt(data);
		System.out.println("解密后数据：" + textDecrypt);
	}
	// 客户端加密
	public static String DESAndRSAEncrypt(String pwd) throws Exception {
