...
public abstract class Routes {
	...
	/**
	 * Add route from package.
	 * 
	 * @param strpackage:package of controller.
	 * @return
	 */
	public Routes scanPackage(String strpackage){
		List<Class> app_clazz = PackageUtils
				.getClasses(strpackage);
		for (Class class1 : app_clazz) {
			Class<Controller> controller = class1;
			this.add(class1.getSimpleName(), controller);
		}
		return this;
	}
